...
//
//
extern volatile rs485_rx_buffer_index_t rs485_rx_buffer_head;
extern volatile rs485_rx_buffer_index_t rs485_rx_buffer_tail;
extern unsigned char rs485_rx_buffer[RS485_RX_BUFFER_SIZE];
